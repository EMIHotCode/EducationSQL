/*
sql - это интерпретируемый язык, т.е. в момент запуск построчное выполнение
-- 'текст содержит''кавычку внутри' она экранируется второй кавычкой.

Запись «первичного ключа» (primary key)
